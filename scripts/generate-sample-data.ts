 ...
 */
function processJsonFile(filePath: string, sourceDir: string, outputDir: string, maxItems: number): void {
  try {
    // Read the JSON file
...
function generateSampleData(config: SampleDataConfig): void {
  ...
  try {
    ...
    for (const filePath of jsonFiles) {
      try {
        processJsonFile(filePath, config.sourceDir, config.outputDir, config.maxItems)
        processedCount++
