...
export namespace PlayerEquipmentAddRequest {
  ...
  export function serialize(
    writer: BinaryWriter,
    value: PlayerEquipmentAddRequest
  ): void {
    PlayerEquipmentAddRequest.getTypeScriptAlgebraicType().serialize(
      writer,
      value
    )
  }
  ...
  export function deserialize(reader: BinaryReader): PlayerEquipmentAddRequest {
    return PlayerEquipmentAddRequest.getTypeScriptAlgebraicType().deserialize(
      reader
    )
  }
}
