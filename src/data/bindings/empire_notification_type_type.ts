...
export type EmpireNotificationType =
  | EmpireNotificationType.None
  | EmpireNotificationType.NewMember
  ...
  | EmpireNotificationType.MemberLeft
  | EmpireNotificationType.WatchtowerBuilt
  | EmpireNotificationType.ClaimJoined
  | EmpireNotificationType.ClaimLeft
