...
export type TraversalSettings =
  | TraversalSettings.None
  | TraversalSettings.FinishMove
  | TraversalSettings.Walk
  | TraversalSettings.StepUp
  | TraversalSettings.Hoist1
  | TraversalSettings.Down1
  | TraversalSettings.WalkSwimTransition
  | TraversalSettings.SwimHoist
  | TraversalSettings.Down1Swim
