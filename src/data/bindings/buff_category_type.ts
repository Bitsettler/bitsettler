...
export type BuffCategory =
  | BuffCategory.None
  | BuffCategory.Generic
  | BuffCategory.Rested
  | BuffCategory.RezSicknessShortTerm
  | BuffCategory.RezSicknessLongTerm
  | BuffCategory.InnerLight
  | BuffCategory.Darkness
  | BuffCategory.CarryCargo
  | BuffCategory.Freezing
  | BuffCategory.Overheating
  | BuffCategory.FriendWarpDebuff
  | BuffCategory.Starving
  | BuffCategory.ElevatorSickness
  | BuffCategory.NearbyFlame
