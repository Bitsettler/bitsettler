...
export type MessageContents =
  | MessageContents.TableUpdate
  | MessageContents.TransferPlayerRequest
  | MessageContents.TransferPlayerHousingRequest
  | MessageContents.PlayerCreateRequest
  | MessageContents.UserUpdateRegionRequest
  | MessageContents.OnPlayerNameSetRequest
  | MessageContents.ClaimCreateEmpireSettlementState
  | MessageContents.OnClaimMembersChanged
  | MessageContents.EmpireCreateBuilding
  | MessageContents.OnEmpireBuildingDeleted
  | MessageContents.GlobalDeleteEmpireBuilding
  | MessageContents.DeleteEmpire
  | MessageContents.EmpireClaimJoin
  | MessageContents.EmpireResupplyNode
  | MessageContents.EmpireCollectHexiteCapsule
  | MessageContents.EmpireStartSiege
  | MessageContents.EmpireSiegeAddSupplies
  | MessageContents.OnPlayerJoinedEmpire
  | MessageContents.OnPlayerLeftEmpire
  | MessageContents.RegionDestroySiegeEngine
  | MessageContents.OnRegionPlayerCreated
  | MessageContents.EmpireQueueSupplies
  | MessageContents.EmpireUpdateEmperorCrown
  | MessageContents.EmpireRemoveCrown
  | MessageContents.SignPlayerOut
  | MessageContents.AdminBroadcastMessage
  | MessageContents.PlayerSkipQueue
  | MessageContents.GrantHubItem
  | MessageContents.RecoverDeployable
  | MessageContents.OnDeployableRecovered
