...
export type BuildingCategory =
  ...
  | BuildingCategory.Crafting
  | BuildingCategory.Residential
  | BuildingCategory.TownHall
  | BuildingCategory.Wall
  | BuildingCategory.TradingPost
  | BuildingCategory.Ornamental
  | BuildingCategory.AncientRuins
  | BuildingCategory.ClaimTotem
  | BuildingCategory.TerrraformingBase
  | BuildingCategory.Barter
  | BuildingCategory.Portal
  | BuildingCategory.RentTerminal
  | BuildingCategory.Watchtower
  | BuildingCategory.EmpireFoundry
  | BuildingCategory.Sign
  | BuildingCategory.Gate
  | BuildingCategory.Bed
  | BuildingCategory.Waystone
  | BuildingCategory.Bank
  | BuildingCategory.Elevator
  | BuildingCategory.TownMarket
  | BuildingCategory.RecoveryChest
