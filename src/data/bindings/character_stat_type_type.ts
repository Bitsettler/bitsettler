...
export type CharacterStatType =
  ...
  | CharacterStatType.ColdProtection
  | CharacterStatType.HeatProtection
  | CharacterStatType.Evasion
  | CharacterStatType.ToolbeltSlots
  | CharacterStatType.CraftingSpeed
  | CharacterStatType.GatheringSpeed
  | CharacterStatType.BuildingSpeed
  | CharacterStatType.SatiationRegenRate
  | CharacterStatType.MaxSatiation
  | CharacterStatType.DefenseLevel
  | CharacterStatType.ForestrySpeed
  | CharacterStatType.CarpentrySpeed
  | CharacterStatType.MasonrySpeed
  | CharacterStatType.MiningSpeed
  | CharacterStatType.SmithingSpeed
  | CharacterStatType.ScholarSpeed
  | CharacterStatType.LeatherworkingSpeed
  | CharacterStatType.HuntingSpeed
  | CharacterStatType.TailoringSpeed
  | CharacterStatType.FarmingSpeed
  | CharacterStatType.FishingSpeed
  | CharacterStatType.CookingSpeed
  | CharacterStatType.ForagingSpeed
  | CharacterStatType.ForestryPower
  | CharacterStatType.CarpentryPower
  | CharacterStatType.MasonryPower
  | CharacterStatType.MiningPower
  | CharacterStatType.SmithingPower
  | CharacterStatType.ScholarPower
  | CharacterStatType.LeatherworkingPower
  | CharacterStatType.HuntingPower
  | CharacterStatType.TailoringPower
  | CharacterStatType.FarmingPower
  | CharacterStatType.FishingPower
  | CharacterStatType.CookingPower
  | CharacterStatType.ForagingPower
  | CharacterStatType.ActiveHealthRegenRate
  | CharacterStatType.ActiveStaminaRegenRate
  | CharacterStatType.ClimbProficiency
  | CharacterStatType.ExperienceRate
  | CharacterStatType.Accuracy
