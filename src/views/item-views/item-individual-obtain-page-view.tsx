      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        {totalRecipes === 0 ? (
          <p className="text-muted-foreground">
            No recipes found that produce this item. This item may be obtained
            through other means such as rewards, trading, or special events.
          </p>
        ) : (
          <p className="text-muted-foreground">
            Found {totalRecipes} recipe{totalRecipes !== 1 ? 's' : ''} that
            produce this item.
          </p>
        )}
      </div>
