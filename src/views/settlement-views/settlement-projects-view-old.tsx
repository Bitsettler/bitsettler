                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-2">
                        ...
                        <p className="text-2xl font-bold">{Array.isArray(projects) ? projects.filter(p => p.status === 'Active').length : 0}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-2">
                        ...
                        <p className="text-2xl font-bold">{Array.isArray(projects) ? projects.filter(p => p.status === 'Completed').length : 0}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-2">
                        ...
                        <p className="text-2xl font-bold">
                          {Array.isArray(projects) ? projects.reduce((contributors, project) => {
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-2">
                        ...
                        <p className="text-2xl font-bold">
                          {Array.isArray(projects) && projects.length > 0 ? Math.round(
