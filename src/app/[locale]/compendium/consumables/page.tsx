import { getConsumableStatistics } from '@/lib/spacetime-db-new/modules/items/flows'
import { getConsumableTagsMetadata } from '@/lib/spacetime-db-new/modules/items/flows'
