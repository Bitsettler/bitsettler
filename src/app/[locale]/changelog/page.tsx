        ...
        <div className="mx-auto max-w-4xl">
          ...
          <Card className="mb-8">
            <CardHeader>
              ...
              <p className="text-muted-foreground">
                Patch update: standardized import paths for better
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Standardized all imports to use the `@/*` convention for
                        better maintainability and consistent code organization
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Updated tsconfig.json to map `@/*` to `./src/*` for
                        consistent import paths and improved developer
                        experience.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Refactored all component imports to use the new
                        convention, improving code organization and
          ...
          <Card className="mb-8">
            <CardHeader>
              ...
              <p className="text-muted-foreground">
                Patch update: new tree-view favicon, improved project structure,
                and middleware fixes
              </p>
            </CardHeader>
            <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        New tree-view favicon and app icon with dynamic
                        generation using Next.js 13+ conventions. The icon
                        represents the hierarchical nature of crafting recipes.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Consolidated duplicate lib folders into a single
                        organized structure for better maintainability and
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Fixed middleware configuration to properly handle
                        dynamic favicon and icon generation routes, ensuring
          ...
          <Card className="mb-8">
            <CardHeader>
              ...
              <p className="text-muted-foreground">
                Minor update: debug mode, improved quantity logic, and better
                user feedback for recipe calculator
              </p>
            </CardHeader>
            <CardContent className="space-y-6">
              {/* New Features Section */}
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        When running in development mode, item and recipe IDs
                        are displayed in each node for easier debugging and data
                        validation.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Added toast notifications (using shadcn/ui Sonner) to
                        inform users when they attempt to set a quantity below
                        the minimum craftable amount. All toast messages are now
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        The calculator now displays a helper message below the
                        quantity input, showing the minimum allowed value for
                        each recipe.
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        The quantity input now defaults to the recipe&apos;s
                        output amount, and users can freely type any value.
                        Validation and correction occur on blur, with clear
                        feedback.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Users are now clearly informed when they attempt to set
                        a quantity below the minimum, and the input is
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Material requirements now correctly scale with recipe
                        output (e.g., 1 plank for 10 buckets), and all
                        child/descendant node quantities are accurate for all
                        recipes.
                      </p>
                    </div>
                  </div>
              ...
              <div className="pt-4 text-center">
                <p className="text-muted-foreground text-sm">
                  Debug mode, smarter quantity logic, and better user feedback
                  for a smoother crafting experience! 🛠️✨
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="mb-8">
            <CardHeader>
              ...
              <p className="text-muted-foreground">
                Major update: full internationalization support with English,
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Complete i18n support with English, French, and Spanish
                        languages. All UI text is now translatable and the site
                        automatically adapts to the user&apos;s language
                        preference.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Added a language switcher component in the header
                        allowing users to easily switch between supported
                        languages with a dropdown menu.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Page titles and descriptions are now translated for
                        better SEO and user experience in each supported
                        language.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Added exported locale and language types for better
                        TypeScript support and consistency across the
                        application.
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        ...
                        The entire interface now supports multiple languages
                        seamlessly.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Updated metadata generation to use translations instead
                        of hardcoded site config values for better localization
                        support.
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Integrated next-intl for robust internationalization
                        support with automatic locale detection and static
                        generation.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Updated all components to use translation hooks and
                        removed hardcoded text throughout the application.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <Card className="mb-8">
            <CardHeader>
              ...
              <p className="text-muted-foreground">
                Initial release of the {SITE_CONFIG.name} web application
              </p>
            </CardHeader>
            <CardContent className="space-y-6">
              {/* New Features Section */}
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Visual flow diagrams showing crafting dependencies and
                        requirements for any item in the game.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Calculate exact material requirements for any desired
                        output quantity with automatic recipe scaling.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Search through all items, cargo, and resources with
                        detailed information including tier, rarity, and
                        category.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Internationalization support for English, French, and
                        Spanish with easy language switching.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Beautiful, responsive interface built with shadcn/ui
                        components and Tailwind CSS, optimized for both desktop
                        and mobile.
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Built using actual game data from BitCraft server files,
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Virtualized search, efficient data structures, and
                        optimized rendering for smooth performance even with
                        large datasets.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        ...
                        patterns for maintainability and type safety.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="pt-4 text-center">
                <p className="text-muted-foreground text-sm">
                  This marks the first MVP release of the {SITE_CONFIG.name} web
                  app. 🎉
                </p>
              </div>
            </CardContent>
