...
/**
 * Settlement Authentication Guard
 * 
 * Ensures user is both authenticated AND has claimed a settlement character.
 * If not, shows appropriate login or onboarding flow.
 */
export function SettlementAuthGuard({ children }: SettlementAuthGuardProps) {
  ...
  // Loading state - checking authentication and membership
  ...
  // Authenticated and has claimed character - show protected content
  return <>{children}</>;
}