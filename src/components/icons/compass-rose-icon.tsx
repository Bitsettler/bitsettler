...
export function CompassRoseIcon(props: React.ComponentPropsWithoutRef<'svg'> & { width?: number; height?: number }) {
  ...
  return (
    <svg
      ...
      fill="currentColor"
      viewBox="0 0 256 256"
      style={{ transform: 'rotate(32deg)', transformOrigin: 'center' }}
      {...rest}
    >
