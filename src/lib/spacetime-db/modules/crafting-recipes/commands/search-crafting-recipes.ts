    ...
    return filters.some((filter) => {
      ...
      return Object.entries(filter).every(([key, value]) => {
        ...
        switch (key) {
          ...
          case 'inputItemId':
            return recipe.consumedItemStacks.some((stack) => Array.isArray(stack) && stack[0] === value)

          case 'outputItemId':
            return recipe.craftedItemStacks.some((stack) => Array.isArray(stack) && stack[0] === value)
